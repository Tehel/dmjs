...
void DBank::Initialize(void) // TAG00332a
{
  ...
  // Pointer22816 = "CAN'T MODIFY CHAOS STRIKES BACK DISK!"; // unused
  // Pointer22820 = "THAT'S NOT THE MASTER DISK!"; // unused
...
//;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  ...
  {
    //A3 = NULL;
    //SubstDiskLetter(LOCAL_80, "PUT THE CHAOS STRIKES BACK DISK IN ~", 1);
    //do
    //{
    //  while (D7W != 0)
    //  {
...
void TAG021800(i32 num) // free num (rounded above) bytes
{
